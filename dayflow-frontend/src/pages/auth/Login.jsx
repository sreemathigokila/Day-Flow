    ...
    <div className="min-h-screen bg-slate-100 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-3xl border border-slate-200 shadow-xl p-8 space-y-6">
        <div className="text-center space-y-2">
          <div className="w-12 h-12 rounded-2xl bg-gradient-to-tr from-cyan-500 via-blue-600 to-purple-600 flex items-center justify-center text-white font-black text-2xl mx-auto shadow-lg shadow-cyan-500/25">
            D
          </div>
          <h1 className="text-2xl font-black text-slate-800 tracking-tight">Dayflow HRMS</h1>
          <p className="text-xs font-medium text-slate-500">Sign in to your role-based portal & AI assistant</p>
        </div>
        ...
        <div className="space-y-2 pt-2">
          ...
          <div className="grid grid-cols-3 gap-2">
            <button
              ...
              className="p-2.5 bg-purple-50 hover:bg-purple-100 border border-purple-200 rounded-xl text-purple-700 font-bold text-xs flex flex-col items-center gap-1 transition-all"
            >
              <Shield className="w-4 h-4" /> ADMIN
            </button>
            <button
              onClick={() => handleLogin(null, 'hr.sarah@dayflow.com', 'Hr@12345')}
              className="p-2.5 bg-cyan-50 hover:bg-cyan-100 border border-cyan-200 rounded-xl text-cyan-800 font-bold text-xs flex flex-col items-center gap-1 transition-all"
            >
              <Briefcase className="w-4 h-4" /> HR USER
            </button>
            <button
              onClick={() => handleLogin(null, 'emp.alex@dayflow.com', 'Emp@12345')}
              className="p-2.5 bg-emerald-50 hover:bg-emerald-100 border border-emerald-200 rounded-xl text-emerald-700 font-bold text-xs flex flex-col items-center gap-1 transition-all"
            >
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:bg-white"
              />
            </div>
          </div>
