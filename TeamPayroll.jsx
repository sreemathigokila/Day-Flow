...
const TeamPayroll = () => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-xl font-extrabold text-slate-800 tracking-tight">Assigned Team Payroll Overview</h1>
        <p className="text-xs text-slate-500">View salary details and disbursement statuses for assigned employees</p>
      </div>
