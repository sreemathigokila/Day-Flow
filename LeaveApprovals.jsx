...
const LeaveApprovals = () => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-xl font-extrabold text-slate-800 tracking-tight">Assigned Employee Leave Requests</h1>
        <p className="text-xs text-slate-500">Approve or reject leave applications submitted by your assigned team members</p>
      </div>
                    ...
                    <td className="py-4 px-6 text-right">
                      {r.status === 'PENDING' ? (
                        <button
                          ...
                          className="py-1.5 px-3 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-xl text-xs"
                        >
                          Review Request
                        </button>
                      ) : (
